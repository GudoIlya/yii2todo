...
$this->params['breadcrumbs'][] = ['label' => 'Мои подключенные товары', 'url' => ['/profile/estateproduct']];
...
<div class="services-view">
    ...
    <p>
        <?= Html::a('Update', ['update', 'id' => $model->id, 'type' => $currentProduct->type], ['class' => 'btn btn-primary']) ?>
